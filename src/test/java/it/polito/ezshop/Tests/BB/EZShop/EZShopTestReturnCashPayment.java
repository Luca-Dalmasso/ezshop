...
public class EZShopTestReturnCashPayment {
	...
	public void testMissingRT() throws InvalidTransactionIdException, InvalidCreditCardException, UnauthorizedException {
		assertTrue(-1 == ez.returnCashPayment(9));
	}
	
	@Test
	public void testOpendRT() throws InvalidTransactionIdException, InvalidCreditCardException, UnauthorizedException, InvalidProductDescriptionException, InvalidProductCodeException, InvalidPricePerUnitException, InvalidQuantityException, InvalidProductIdException, InvalidPaymentException {
		...
		assertTrue(-1 == ez.returnCashPayment(rId));
	}
	
	@Test
	public void testInsufficientMoney() throws InvalidTransactionIdException, InvalidCreditCardException, UnauthorizedException, InvalidProductDescriptionException, InvalidProductCodeException, InvalidPricePerUnitException, InvalidQuantityException, InvalidProductIdException, InvalidPaymentException {
		String code = "012345000010";
	...
	@Test
	public void testReturn() throws InvalidTransactionIdException, InvalidCreditCardException, UnauthorizedException, InvalidProductDescriptionException, InvalidProductCodeException, InvalidPricePerUnitException, InvalidQuantityException, InvalidProductIdException, InvalidPaymentException {
		String code = "012345000010";
		...
		ez.returnProduct(rId, code, 1);
		ez.endReturnTransaction(rId, true);
		assertTrue(1.0 == ez.returnCashPayment(rId));
	}
