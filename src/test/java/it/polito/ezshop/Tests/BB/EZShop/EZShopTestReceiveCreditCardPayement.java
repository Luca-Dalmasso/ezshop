...
public class EZShopTestReceiveCreditCardPayement {
	...
	@Test
	public void testEmptyCC() throws UnauthorizedException, InvalidTransactionIdException, InvalidCreditCardException, InvalidProductDescriptionException, InvalidProductCodeException, InvalidPricePerUnitException, InvalidQuantityException, InvalidProductIdException {
		...
		assertFalse(ez.receiveCreditCardPayment(sId, "4716258050958645"));
	}
	
	@Test
	public void testReceiveCCPayement() throws UnauthorizedException, InvalidTransactionIdException, InvalidCreditCardException, InvalidProductDescriptionException, InvalidProductCodeException, InvalidPricePerUnitException, InvalidQuantityException, InvalidProductIdException {
		String code = "012345000010";
		int pId = ez.createProductType("milk", code, 1.0, "bio");
		ez.updateQuantity(pId, 5);
		int sId = ez.startSaleTransaction();
		ez.addProductToSale(sId, code, 1);
		ez.endSaleTransaction(sId);
		assertTrue(ez.receiveCreditCardPayment(sId, "4485370086510891"));
	}
