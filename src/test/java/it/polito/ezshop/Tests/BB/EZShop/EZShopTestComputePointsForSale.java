...
public class EZShopTestComputePointsForSale {
	...
	@Before
	public void beforeEachTest() throws InvalidUsernameException, InvalidPasswordException, InvalidRoleException, InvalidTransactionIdException, InvalidProductCodeException, InvalidQuantityException, UnauthorizedException, InvalidProductDescriptionException, InvalidPricePerUnitException, InvalidProductIdException {
		ez.reset();
		...
		pId = ez.createProductType("Tomato", pCode, 10, "bio");
	...
	public void testNotExistingSale() throws InvalidTransactionIdException, UnauthorizedException {
		assertTrue(ez.computePointsForSale(saleId + 1) == -1);
	}
	
	@Test
	public void testSuccesfulComputeSale() throws InvalidTransactionIdException, UnauthorizedException {
		assertTrue(ez.computePointsForSale(saleId) == 5);
	}
