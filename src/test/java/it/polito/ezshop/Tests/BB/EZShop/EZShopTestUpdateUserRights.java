...
public class EZShopTestUpdateUserRights {
	...
	@Test
	public void testUpdate() throws InvalidUsernameException, InvalidPasswordException, InvalidRoleException, InvalidUserIdException, UnauthorizedException {
		Integer id = ez.createUser("test", "test", "Administrator");
		assertTrue(ez.updateUserRights(id, "Cashier"));
	}
